...
INC_DIR  = include
OBJ_DIR  = obj
OBJS     = $(addprefix $(OBJ_DIR)/, main.o Movie.o User.o Rating.o Base.o MovieManager.o UserManager.o RatingManager.o Recommender.o Menu.o Statistics.o DataGenerator.o)
...
$(OBJ_DIR)/main.o: $(SRC_DIR)/main.cpp $(INC_DIR)/MovieManager.h $(INC_DIR)/UserManager.h $(INC_DIR)/RatingManager.h $(INC_DIR)/Recommender.h $(INC_DIR)/Statistics.h $(INC_DIR)/BaseManager.h $(INC_DIR)/Menu.h
...
$(OBJ_DIR)/DataGenerator.o: $(SRC_DIR)/DataGenerator.cpp $(INC_DIR)/DataGenerator.h
$(OBJ_DIR)/Menu.o: $(SRC_DIR)/Menu.cpp $(INC_DIR)/Menu.h $(INC_DIR)/MovieManager.h $(INC_DIR)/UserManager.h $(INC_DIR)/RatingManager.h $(INC_DIR)/Recommender.h $(INC_DIR)/Statistics.h $(INC_DIR)/MovieConstant.h
$(OBJ_DIR)/Statistics.o: $(SRC_DIR)/Statistics.cpp $(INC_DIR)/Statistics.h $(INC_DIR)/MovieManager.h $(INC_DIR)/UserManager.h $(INC_DIR)/RatingManager.h
